        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, pt: 2 }}>
          <Box>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
              ...
              <TextField label={t('websites.form.logoUrl')} value={formData.logoUrl} onChange={(e) => onFormChange('logoUrl', e.target.value)} fullWidth variant="outlined" placeholder={t('websites.form.logoUrlPlaceholder')} error={!!getFieldError('logoUrl')} helperText={getFieldError('logoUrl') || 'Enter the logo URL (optional)'} sx={{ '& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: 'primary.main', borderWidth: '2px' } }} />
              {/* Description */}
