...
interface WebsiteSearchPanelProps {
  ...
  loading: boolean;
  onFormChange: (field: keyof WebsiteSearchFormData, value: any) => void;
  onSearch: () => void;
  onClear: () => void;
}

export const WebsiteSearchPanel: React.FC<WebsiteSearchPanelProps> = ({
  searchFormData,
  loading,
  onFormChange,
  onSearch,
        ...
        <Box sx={{ 
          ...
          <Box>
            ...
            <TextField
              ...
              placeholder={t('websites.filters.searchByName')}
              disabled={loading}
              sx={{
