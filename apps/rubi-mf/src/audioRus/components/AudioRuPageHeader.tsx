...
interface AudioRuPageHeaderProps {
  onCreateAudioRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const AudioRuPageHeader: React.FC<AudioRuPageHeaderProps> = ({
  onCreateAudioRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
...
export default AudioRuPageHeader;
