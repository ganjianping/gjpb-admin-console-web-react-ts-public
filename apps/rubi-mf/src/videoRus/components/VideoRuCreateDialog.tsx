  ...
  return (
    ...
    >
      ...
      <DialogTitle sx={{ pt: loading ? 3 : 2 }}>
        {t('videoRus.create') || 'Create Video'}
      </DialogTitle>
      <DialogContent sx={{ pt: 2 }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 1 }}>
          {/* Video File Upload */}
          <Typography variant="subtitle1" sx={{ fontWeight: 600 }}>
            {t('videoRus.form.videoFile') || 'Video File'}
          </Typography>
          <Box>
            <Button
              variant="outlined"
          ...
          <TextField
            ...
            fullWidth
            helperText={t('videoRus.form.filenameHelp') || 'Optional - auto-filled from selected file'}
          />

          {/* Cover Image Upload */}
          <Typography variant="subtitle1" sx={{ fontWeight: 600, mt: 2 }}>
            {t('videoRus.form.coverImage') || 'Cover Image (Optional)'}
          </Typography>
          <Box>
            <Button
              variant="outlined"
          ...
          <TextField
            ...
            fullWidth
            helperText={t('videoRus.form.coverImageFilenameHelp') || 'Optional - auto-filled from selected file'}
          />
      ...
      <DialogActions sx={{ px: 3, pb: 2 }}>
        ...
        <Button
          ...
          disabled={loading || localSaving || !formData.videoFile}
        >
          {(loading || localSaving) ? (
