...
interface VideoRuPageHeaderProps {
  onCreateVideoRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const VideoRuPageHeader: React.FC<VideoRuPageHeaderProps> = ({
  onCreateVideoRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
...
export default VideoRuPageHeader;
