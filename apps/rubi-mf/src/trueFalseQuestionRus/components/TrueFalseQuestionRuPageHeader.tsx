...
interface TrueFalseQuestionRuPageHeaderProps {
  onCreateTrueFalseQuestionRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const TrueFalseQuestionRuPageHeader: React.FC<TrueFalseQuestionRuPageHeaderProps> = ({
  onCreateTrueFalseQuestionRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
    ...
    <Box sx={{ mb: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
        <Box>
          ...
          >
            {t('trueFalseQuestionRus.pageTitle')}
          </Typography>
          <Typography variant='body2' color='text.secondary'>
            {t('trueFalseQuestionRus.subtitle')}
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center' }}>
          ...
          <Button
            ...
            onClick={onCreateTrueFalseQuestionRu}
            sx={{
              borderRadius: 2,
              px: 2.5,
              py: 1,
...
export default TrueFalseQuestionRuPageHeader;
