...
const TrueFalseQuestionRuCreateDialog = ({
  ...
  const availableGrammarChapters = useMemo(() => {
    try {
      ...
      console.error("[TrueFalseQuestionRuCreateDialog] Error loading grammar chapters:", err);
      return [] as string[];
    }
  }, [i18n.language]);
  ...
  const availableScienceChapters = useMemo(() => {
    try {
      ...
      console.error("[TrueFalseQuestionRuCreateDialog] Error loading science chapters:", err);
      return [] as string[];
    }
  }, [i18n.language]);
