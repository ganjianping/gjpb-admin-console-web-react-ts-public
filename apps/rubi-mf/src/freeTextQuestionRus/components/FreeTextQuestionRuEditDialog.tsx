...
const FreeTextQuestionRuEditDialog = ({
  ...
  const availableGrammarChapters = useMemo(() => {
    try {
      ...
      console.error("[FreeTextQuestionRuEditDialog] Error loading grammar chapters:", err);
      return [] as string[];
    }
  }, [i18n.language]);
  ...
  const availableScienceChapters = useMemo(() => {
    try {
      ...
      console.error("[FreeTextQuestionRuEditDialog] Error loading science chapters:", err);
      return [] as string[];
    }
  }, [i18n.language]);
