...
interface FreeTextQuestionRuPageHeaderProps {
  onCreateFreeTextQuestionRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const FreeTextQuestionRuPageHeader: React.FC<FreeTextQuestionRuPageHeaderProps> = ({
  onCreateFreeTextQuestionRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
    ...
    <Box sx={{ mb: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
        <Box>
          ...
          >
            {t('freeTextQuestionRus.pageTitle')}
          </Typography>
          <Typography variant='body2' color='text.secondary'>
            {t('freeTextQuestionRus.subtitle')}
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center' }}>
          ...
          <Button
            ...
            onClick={onCreateFreeTextQuestionRu}
            sx={{
              borderRadius: 2,
              px: 2.5,
              py: 1,
...
export default FreeTextQuestionRuPageHeader;
