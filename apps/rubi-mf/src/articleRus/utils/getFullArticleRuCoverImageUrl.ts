...
/**
 * Build a fully qualified articleRu cover image URL.
 * Mirrors the behavior of the audio helper while using the articleRu-specific base URL setting.
 */
export const getFullArticleRuCoverImageUrl = (imagePath?: string | null): string => {
  if (!imagePath) {
    return '';
  }
...
export default getFullArticleRuCoverImageUrl;
