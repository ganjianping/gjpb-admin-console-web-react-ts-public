...
interface ArticleRuPageHeaderProps {
  onCreateArticleRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const ArticleRuPageHeader: React.FC<ArticleRuPageHeaderProps> = ({
  onCreateArticleRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
    ...
    <Box sx={{ mb: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
        <Box>
          ...
          >
            {t('articleRus.pageTitle')}
          </Typography>
          <Typography variant='body2' color='text.secondary'>
            {t('articleRus.subtitle')}
          </Typography>
        </Box>
...
export default ArticleRuPageHeader;
