...
interface FillBlankQuestionRuPageHeaderProps {
  onCreateFillBlankQuestionRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const FillBlankQuestionRuPageHeader: React.FC<FillBlankQuestionRuPageHeaderProps> = ({
  onCreateFillBlankQuestionRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
    ...
    <Box sx={{ mb: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
        <Box>
          ...
          >
            {t('fillBlankQuestionRus.pageTitle')}
          </Typography>
          <Typography variant='body2' color='text.secondary'>
            {t('fillBlankQuestionRus.subtitle')}
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center' }}>
          ...
          <Button
            ...
            onClick={onCreateFillBlankQuestionRu}
            sx={{
              borderRadius: 2,
              px: 2.5,
              py: 1,
...
export default FillBlankQuestionRuPageHeader;
