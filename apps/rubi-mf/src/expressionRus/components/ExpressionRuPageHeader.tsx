...
interface ExpressionRuPageHeaderProps {
  onCreateExpressionRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const ExpressionRuPageHeader: React.FC<ExpressionRuPageHeaderProps> = ({
  onCreateExpressionRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
    ...
    <Box sx={{ mb: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
        <Box>
          ...
          >
            {t('expressionRus.pageTitle')}
          </Typography>
          <Typography variant='body2' color='text.secondary'>
            {t('expressionRus.subtitle')}
          </Typography>
        </Box>
...
export default ExpressionRuPageHeader;
