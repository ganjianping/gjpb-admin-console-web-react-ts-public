...
interface ImageRuPageHeaderProps {
  onCreateImageRu: () => void;
  searchPanelOpen: boolean;
  onToggleSearchPanel: () => void;
}

const ImageRuPageHeader: React.FC<ImageRuPageHeaderProps> = ({
  onCreateImageRu,
  searchPanelOpen,
  onToggleSearchPanel,
}) => {
...
export default ImageRuPageHeader;
