    ...
    <LexicalComposer initialConfig={initialConfig}>
      <Box sx={{ border: '1px solid rgba(0,0,0,0.12)', borderRadius: 1, p: 1 }}>
        <style>{`
          ...
          .lexical-text-editor__input[contenteditable] ol { list-style-type: decimal !important; }
          .lexical-text-editor__input[contenteditable] ul { list-style-type: disc !important; }
        `}</style>
