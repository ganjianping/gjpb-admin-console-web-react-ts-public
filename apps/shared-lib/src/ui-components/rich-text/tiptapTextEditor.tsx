...
export default function TiptapTextEditor(props: Readonly<TiptapTextEditorProps>) {
  ...
  const menuItems: Array<any> = [
    ...
    { id: 'bulleted', label: 'Bulleted list', icon: (size = 16) => (
    ...
    { id: 'numbered', label: 'Numbered list', icon: (size = 16) => (
    ...
    { id: 'quote', label: 'Quote', icon: (size = 16) => (
    ...
    { id: 'code', label: 'Code block', icon: (size = 16) => (
    ...
    { id: 'image', label: 'Image', icon: (size = 16) => (
    ...
    { id: 'link', label: 'Link', icon: (size = 16) => (
                ...
                if (it.children && Array.isArray(it.children)) {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span className="gjp-floating-menu__icon">{it.icon?.(16)}</span>
