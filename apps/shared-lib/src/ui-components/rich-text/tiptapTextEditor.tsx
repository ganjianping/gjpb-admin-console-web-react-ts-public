...
import { HeadingIcon, AlignmentIcon, BulletedIcon, NumberedIcon, QuoteIcon, CodeIcon, ImageIcon, TableIcon, LinkIcon } from './tiptap/icons';
...
// icons moved to ./tiptap/icons.tsx to keep this file focused
