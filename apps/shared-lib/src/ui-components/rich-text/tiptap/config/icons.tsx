...
export const AlignmentIcon = ({ size = 16 }: { size?: number }) => (
...
export const BulletedIcon = ({ size = 16 }: { size?: number }) => (
...
export const NumberedIcon = ({ size = 16 }: { size?: number }) => (
...
export const TableIcon = ({ size = 16 }: { size?: number }) => (
